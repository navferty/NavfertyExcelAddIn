...
![Иконка Парсинг чисел](images/icons/parseNumerics.png)
...
![Иконка Заменить](images/icons/replace.png)

Замена русских символов различными методами преобразования.

### Транслитерацией

![Иконка Транслитерации](images/icons/transliterate.png)
...
![Иконка Замены на аналоги](images/icons/replaceChars.png)
...
![Иконка Преобразовать числа в слова](images/icons/stringifyNumerics.png)
...
![Иконка Изменить регистр](images/icons/toggleCase.png)
...
![Иконка Удалить пробелы](images/icons/trimSpaces.png)
...
![Иконка Снять защиту](images/icons/unprotectWorkbook.png)
...
![Иконка Защита листов](images/icons/unprotectWorkbook.png)

Установка или снятие защиты с нескольких листов одновременно.

## Подсветить дубликаты

![Иконка Подсветить дубликаты](images/icons/highlightDuplicates.png)
...
![Иконка Разъединить ячейки](images/icons/unmergeCells.png)
...
![Иконка Найти все ошибки](images/icons/findErrors.png)
...
![Иконка Копировать в Markdown](images/icons/markdown.png)
...
![Иконка Валидация значений](images/icons/validation.png)
...
![Иконка Экспорт в SQLite](images/icons/validation.png)
...
![Иконка Создать образец XML](images/icons/createSampleXml.png)
...
![Иконка Валидация XML](images/icons/validateXml.png)
...
![Иконка Отменить последнее действие](images/icons/undo.png)
