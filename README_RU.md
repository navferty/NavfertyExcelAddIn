...
Скачайте, разархивируйте и запустите [файл установки](https://deploy.navferty.ru/setup.zip) для установки надстройки в Excel.
...
1. Скачайте и разархивируйте [setup.exe](https://deploy.navferty.ru/setup.zip)
