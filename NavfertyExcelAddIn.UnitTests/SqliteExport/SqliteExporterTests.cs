...
namespace NavfertyExcelAddIn.UnitTests.SqliteExport
{
	...
	public class SqliteExporterTests : TestsBase
	{
		...
		[TestMethod]
		public void ExportToSqlite_WithOptions_UseFirstRowAsHeaders_UsesHeaderNames()
		{
			var workbook = new Mock<Workbook>(MockBehavior.Loose);
			var worksheets = new Mock<Sheets>(MockBehavior.Loose);
			var worksheet = new Mock<Worksheet>(MockBehavior.Loose);
		...
		[TestMethod]
		public void ExportToSqlite_WithOptions_SkipRows_SkipsSpecifiedRows()
		{
			var workbook = new Mock<Workbook>(MockBehavior.Loose);
			var worksheets = new Mock<Sheets>(MockBehavior.Loose);
			var worksheet = new Mock<Worksheet>(MockBehavior.Loose);
		...
		[TestMethod]
		public void ExportToSqlite_WithOptions_IntegerColumn_CreatesIntegerType()
		{
			var workbook = new Mock<Workbook>(MockBehavior.Loose);
			var worksheets = new Mock<Sheets>(MockBehavior.Loose);
			var worksheet = new Mock<Worksheet>(MockBehavior.Loose);
		...
		[TestMethod]
		public void ExportToSqlite_WithOptions_RealColumn_CreatesRealType()
		{
			var workbook = new Mock<Workbook>(MockBehavior.Loose);
			var worksheets = new Mock<Sheets>(MockBehavior.Loose);
			var worksheet = new Mock<Worksheet>(MockBehavior.Loose);
		...
		[TestMethod]
		public void ExportToSqlite_WithOptions_NoHeaders_UsesDefaultColumnNames()
		{
			var workbook = new Mock<Workbook>(MockBehavior.Loose);
			var worksheets = new Mock<Sheets>(MockBehavior.Loose);
			var worksheet = new Mock<Worksheet>(MockBehavior.Loose);
			...
			using (var connection = new SQLiteConnection($"Data Source={testDbPath};Version=3;"))
			{
				...
				{
					var count = (long)command.ExecuteScalar();
					Assert.AreEqual(2, count); // Both rows should be data
				}
			}
